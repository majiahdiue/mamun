...
import com.hyappinc.redxvpn.adapter.AdapterBannerAdsSliderRecyclerView;
...
public class AdsManager {
    ...
    //TODO change this if you want to limit interstitial ads
    public static int NUMBER_OF_INTERSTITIAL_ADS_PER_SESSION = 10;
    ...
    public static void loadVideoAdAdmob(final Activity activity) {
        try {
            ...
            if (nn != null && nn.equals("nnn") && Constants.show_Ads && !Constants.isSubactive) {
                ...
                RewardedAd.load(activity, activity.getString(R.string.AdmobRewardID),
            ...
            InterstitialAd.load(context, context.getString(R.string.AdmobInterstitial), adRequest, new InterstitialAdLoadCallback() {
                ...
                public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                    if (AdsManager.NUMBER_OF_INTERSTITIAL_ADS_SHOWN < AdsManager.NUMBER_OF_INTERSTITIAL_ADS_PER_SESSION) {
                        ...
                        AdsManager.NUMBER_OF_INTERSTITIAL_ADS_SHOWN++;
